...
describe('favorite blog', () => {
  ...
  test('when a list has multiple objects with the same amount of max likes', () => {
    const result = listHelper.favoriteBlog(equalAmountOfMaxLikes)
